    ...
    return (
      <div className="min-h-screen bg-[#070b14] flex flex-col items-center justify-center text-slate-400 gap-3">
        ...
        <div className="text-center space-y-1">
          <p className="text-xs font-mono font-medium text-slate-200">Verifying 24h Session with Backend...</p>
          <p className="text-[11px] text-slate-400">Validating PostgreSQL cryptographic token</p>
        </div>
      </div>
    );
  }
