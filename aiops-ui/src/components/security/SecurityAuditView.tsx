  ...
  const securityLayers = [
    {
      ...
      module: 'Ingress Traffic Rate Controller',
    ...
    },
    {
      ...
      module: 'Automated PII & Secret Filter',
      spec: 'Pre-compiled Regex Engine (8 Pattern Groups)',
      description: 'Scrubs cloud keys, JWTs, API tokens, database credentials in connection URIs, emails, and credit cards before passing to analysis.',
    ...
    {
      layer: 'Layer 3',
      name: 'Prompt Injection Defense & Boundary Isolation',
      module: 'Adversarial Injection Defense Firewall',
      spec: '<untrusted_log> Boundary Isolation + Static Guardrails',
      description: 'Isolates untrusted logs in strict XML boundaries with explicit negative constraints while enabling high-throughput execution.',
      status: 'Active (Zero-Leakage Boundary)',
      icon: Terminal,
    ...
    },
    {
      ...
      module: 'Sandboxed Codebase Isolation Guardian',
      spec: 'Strict Directory Jail + Blacklist',
      description: 'Blocks path traversal attacks and prohibits agent access to sensitive files, certificates, private keys, and environment files.',
    ...
    },
    {
      ...
      module: 'Output Guardrail Sanitization Filter',
      spec: 'Automated Secret Scrubbing on Final RCA',
    ...
    },
    {
      ...
      module: 'Read-Only Database Query Enforcer',
